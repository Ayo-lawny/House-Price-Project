...
print(f'\nLogistic Regression Model has been created\n')

# Saving the model
model = pickle.dump(model, open('HousePriceModel.pkl', 'wb'))
print(f'Model is savedf\n\n')

# -----------------------------STREAMLIT DEVELOPMENT-----------------------
model = pickle.load(open('HousePriceModel.pkl', 'rb'))

st.markdown("<h1 style = 'color: #EE9322; text-align: center; font-family: helvetica;'>House Price Predition</h1>", unsafe_allow_html = True)

st.markdown("<h4 style = 'margin: -27px; color: #B0A695; text-align: center; font-family: helvetica;'>Created by Lawny</h4>", unsafe_allow_html = True)

st.image('House.png', width = 600)
...
st.sidebar.image('User.png', caption = f'Welcome {username}')
...
st.markdown("<h2 style = 'color: #EE9322; text-align: center; font-family: montserrat '>Model Interpretation</h2>", unsafe_allow_html = True)
